...
const demoPrompts = [
  ...
  "What do we know about his favorite football club?"
];

export function MemoryQnaWorkspace({ context }: { context: ClientContext }) {
        ...
        >
          ...
          >
            <input
              ...
              placeholder={`Ask anything about ${context.client.name}`}
